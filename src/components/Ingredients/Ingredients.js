...
const Ingredients = () => {
  ...
  const addIngredientHandler = useCallback((ingredient) => {
    sendRequest('https://react-hooks-52b97.firebaseio.com/ingredients.json', 'POST', JSON.stringify(ingredient), ingredient, 'ADD_INGREDIENT')
  }, [sendRequest])

  const removeIngredientHandler = useCallback((id) => {
    const url = `https://react-hooks-52b97.firebaseio.com/ingredients/${id}.json`
